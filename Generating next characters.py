...
# Load the text
# save the notepad as UTF-8
filename = r"D:\Next word Prediction using LSTM\t8.shakespeare.txt"
...
#check total no. of characters in train text
chars = sorted(list(set(raw_text))) # list of every character


# Characters sequences must be encoded as integers
# Each unique character will be assigned an integer value
# create a dict of characters mapped to integer values
...
# instead of moving 1 letter at a time, try skipping a few
step = 10
#x_values
sentences = []
#y values
...
# features = numbers of character in our vocab (n_vocab)
